    ...
    return `
      <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; max-width: 800px; margin: 0 auto; padding: 40px;">
              ...
              <div style="padding: 20px;">
                ${item.inputs ? `
                  <div style="margin-bottom: 20px;">
                    <h3 style="margin: 0 0 10px 0; font-size: 18px; font-weight: 600; color: #374151;">📊 Inputs</h3>
                ...
                ${item.results ? `
                  <div>
                    <h3 style="margin: 0 0 10px 0; font-size: 18px; font-weight: 600; color: #374151;">💡 Results</h3>
        ...
        <div style="text-align: center; border-top: 2px solid #e5e7eb; padding-top: 20px; color: #6b7280;">
          <p style="margin: 0; font-size: 14px;">🌟 Generated by Universal Finance Calculator</p>
